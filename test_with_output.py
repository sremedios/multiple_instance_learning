...
for dataset_count in [672, 500, 400, 300, 200, 100]:
    ...
    for cur_fold in range(NUM_FOLDS):
        # load model
        weight_path = "/nfs/share5/remedis/projects/multiple_instance_learning/models/weights/class_resnet/dataset_{}/best_weights_fold_{}.h5".format(dataset_count, cur_fold)
        ...
        if not os.path.exists(DST_DIR):
            os.makedirs(DST_DIR)
        dst_file = os.path.join(DST_DIR, "model_predictions_{}_fold_{}".format(dataset_count, cur_fold))
